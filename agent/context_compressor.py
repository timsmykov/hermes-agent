...
SUMMARY_PREFIX = (
    ...
    "they were already addressed or are only historical state. "
    "Use the summary only to preserve facts, files, and prior decisions for "
    "the SAME logical session. It must never override the latest user message "
    "or pull work from another topic/project/session. "
